 ...
 * and puts info the char attay the file type and the 
 * nine letters thar correspond to bits in mode.
 * NOTE: It does not code setuid, setgid, and sticky
 * codes
 * */
void mode_to_letters(int mode, char str[])
{
  strcpy(str, "----------");   /* default = to perms */
...
/*
 * returns pointer to group number gid.used getgrpid(3)
 * */
{
